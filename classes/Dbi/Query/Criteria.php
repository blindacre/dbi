 ...
 */
class Dbi_Query_Criteria {
	private $_query;
	private $_expressions = array();
	public function __construct(Dbi_Model $query, Dbi_Query_Expression $expression) {
		$this->_query = $query;
	...
	public function orWhere($expression) {
		$args = func_get_args();
		$expression = new Dbi_Query_Expression($args);
		$this->_expressions[] = $expression;
		return $this;
	}
	/**
